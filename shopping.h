...
void read_data(int&, int&, int&, std::vector<int>&, std::vector<int>&, std::vector<int>&, std::vector<std::vector<int>>&, const int);
...
std::vector<int> backtrace_family(const std::vector<std::vector<int>>&, const std::vector<int>&, const std::vector<int>&, int, int);
